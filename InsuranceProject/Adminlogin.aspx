<%@ Page Title="" Language="C#" MasterPageFile="~/homepage.Master" AutoEventWireup="true" CodeBehind="Adminlogin.aspx.cs" Inherits="InsuranceProject.Adminlogin" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="150px" src="Image/Adminimg.png" /> 
                        </center>
                     </div>
                  </div>
                  <div class="row">
