    ...
    public partial class Usersignup : System.Web.UI.Page
    {
        ...
        bool CheckContactNumberExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Select ContactNumber from UserRegistration where ContactNumber='" + Mobile.Text.Trim() + "'", con);
        ...
        void NewSignUp()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO UserRegistration (UserId, FirstName, LastName, Mobile, Address, Password, ConfirmPassword) values ( @userId, @fn, @ln, @contact, @address, @pwd, @cpwd)", con);
                cmd.Parameters.AddWithValue("@userId", UserId.Text.Trim());  //Trim is used to remove the spaces in front and back
                ...
                cmd.Parameters.AddWithValue("@contact", Mobile.Text.Trim());
