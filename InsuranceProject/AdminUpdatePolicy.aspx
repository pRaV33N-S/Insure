<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminUpdatePolicy.aspx.cs" Inherits="InsuranceProject.AdminUpdatePolicy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
  ...
  <script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
    ...
    <h3 style="font-size:30px;text-align:center; margin-left:-30px">Update Policy </h3>
        <br />
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" CssClass="auto-style1" DataKeyNames="policy_id" DataSourceID="SqlDataSource1" ForeColor="Black" Height="178px" Width="1301px">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:InsuranceDbConnectionString9 %>" DeleteCommand="DELETE FROM [policies] WHERE [policy_id] = @policy_id" InsertCommand="INSERT INTO [policies] ([SerialNo], [policy_name], [sum_assured], [premium], [tenure], [creation_date]) VALUES (@SerialNo, @policy_name, @sum_assured, @premium, @tenure, @creation_date)" ProviderName="<%$ ConnectionStrings:InsuranceDbConnectionString9.ProviderName %>" SelectCommand="SELECT * FROM [policies]" UpdateCommand="UPDATE [policies] SET [SerialNo] = @SerialNo, [policy_name] = @policy_name, [sum_assured] = @sum_assured, [premium] = @premium, [tenure] = @tenure, [creation_date] = @creation_date WHERE [policy_id] = @policy_id">
            <DeleteParameters>
